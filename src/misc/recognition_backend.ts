...
readurl = "https://poem-amongst-nationally-domains.trycloudflare.com"

export const getEmbeddings = async (url: string ,imageUri) => {
...
export const recognizeWithEmbeddings = async (url: string , imageUri, embeddings) => {
  try {
